...
public class ScanResultAdapter extends BaseAdapter{
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        TextView connectView = (TextView) view.findViewById(R.id.connect);
        ...
        if(scanResult.isConnectable()) {
            ...
            connectView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(mContext, DeviceDataTabActivity.class);
                    intent.putExtra(DeviceDataTabActivity.EXTRAS_DEVICE_NAME, scanResult.getDevice().getName());
                    intent.putExtra(DeviceDataTabActivity.EXTRAS_DEVICE_ADDRESS, scanResult.getDevice().getAddress());
