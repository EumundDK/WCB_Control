...
public class ScannerFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ScanResultAdapter(getActivity(), LayoutInflater.from(getActivity()));
    ...
    public void startScanning() {
        if (mScanCallback == null) {
            ...
            String toastText = getString(R.string.scan_start_toast) + " " + TimeUnit.SECONDS.convert(SCAN_PERIOD, TimeUnit.MILLISECONDS) + " " + getString(R.string.seconds);
